...
<span style="color:#2196F3">温馨提示：</span>本模块不需要勾选“系统”作用域（即使勾选也没问题）
...
-
    - 控件转图片（支持任意控件）
-
    - <span style="color: #2196F3">调用堆栈：</span>可用于定位View是如何被创建的，以达到快速反编译修改

---

- <span style="color: #2196F3">上帝模式（临时）：</span>
-
    - View（常规），支持修改：
-
    -
...
虽然开发者对悬浮窗的优先度进行了优化，但也不可能百分白保证悬浮窗一直不被遮挡，遇到这种情况，<span style="color: #2196F3">
1秒内连续双击音量键即可召唤悬浮窗</span>。